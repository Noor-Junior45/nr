...
const ProductDetailModal: React.FC<ProductDetailModalProps> = ({ product, onClose, isWishlisted, onToggleWishlist }) => {
    ...
    return (
        ...
        >
            ...
            {/* Modal Container */}
            <div className="relative glass-panel bg-white w-full h-[95dvh] sm:h-[85vh] sm:max-w-6xl rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-slide-up sm:animate-popup-in">
                ...
                <div className="absolute top-0 left-0 w-full z-50 p-4 flex justify-between pointer-events-none">
                    ...
                    <button 
                        ...
                        className={`pointer-events-auto w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shadow-lg border transition-all duration-300 ${
                            ...
                            : 'bg-white/80 backdrop-blur text-gray-400 hover:text-red-500 border-gray-100 hover:bg-red-50'
                        }`}
                    ...
                    <button 
                        onClick={onClose} 
                        className="pointer-events-auto bg-white/80 backdrop-blur text-gray-500 hover:text-red-500 rounded-full w-10 h-10 flex items-center justify-center shadow-lg border border-gray-100 transition-colors hover:rotate-90 duration-300"
                ...
                <div className="flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden custom-scrollbar">
                    ...
                    <div className="w-full md:w-5/12 shrink-0 bg-gradient-to-br from-blue-50 via-indigo-50/30 to-white relative flex items-center justify-center p-6 md:p-12 min-h-[250px] md:h-full">
                        ...
                        <div className="relative z-10 w-full max-w-[200px] sm:max-w-[280px] md:max-w-[300px] aspect-square drop-shadow-2xl transform transition-transform duration-500 hover:scale-105">
                    ...
                    <div className="w-full md:w-7/12 bg-white flex flex-col md:h-full md:overflow-hidden">
                        ...
                        <div className="p-4 md:p-6 bg-white border-t border-gray-100 shadow-[0_-5px_20px_rgba(0,0,0,0.02)] z-20 flex flex-col sm:flex-row gap-4">
                            ...
                            <a 
                                ...
                                className="flex-1 py-4 px-6 rounded-xl font-bold bg-medical-600 text-white hover:bg-medical-700 transition-all duration-300 shadow-lg shadow-medical-500/30 hover:shadow-xl hover:-translate-y-1 flex items-center justify-center gap-2 btn-shine"
                            >
